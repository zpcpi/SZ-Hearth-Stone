...
,
				...
				['触发逻辑']={
t =
{'技能效果_添加BUFF',0x10130079},
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_添加BUFF",269680761)
end
,
},
			},
...
lua = function (self, card, info, data)
	...
	return (function()
		local _ = nil
		_ = G.call("技能目标_添加目标",{card})
		_ = G.call("技能效果_添加BUFF",269680770)
		return _
	end)()
end
,
...
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_召唤",{{"我方","右邻",268828807}})
end
,
},
			},
...
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_召唤",{{"我方","右邻",268828822}})
end
,
},
			},
...
t =
{
    ...
    },
    {
        ...
        {},
        {},
        {'技能效果_添加BUFF',0x1013007e}
    }
},
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_效果树_执行子效果",{["Player"] = info.Player,["Target"] = {card}},(function()
		return G.call("技能效果_添加BUFF",269680766)
	end))
end
,
},
...
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_召唤",{{"我方","右邻",268828809}})
end
,
},
			},
...
,
				...
				['触发逻辑']={
t =
{'技能效果_添加BUFF',0x10130069},
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_添加BUFF",269680745)
end
,
},
			},
...
,
				...
				['触发逻辑']={
t =
{'技能效果_添加BUFF',0x1013005f},
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_添加BUFF",269680735)
end
,
},
			},
...
{
    '$流程_回合开始',
    {'房间_获取绝对身份','info.Player'}
},
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return {"流程_回合开始",G.call("房间_获取绝对身份",info.Player)}
end
,
},
				['触发逻辑']={
...
lua = function (self, card, info, data)
	local G = require "gf"
	local t = G.api
	return G.call("技能效果_效果树_执行子效果",{["Player"] = G.call("get_event_info"),["Target"] = {card}},(function()
		return G.call("技能效果_消灭目标")
	end))
end
,
...
lua = function (self, card, info, data)
	...
	local t = G.api
	return (function()
		local player_64 = info.Player
		local count_119 = t["tLua_SUB"](G.call("角色_获取随从数量",player_64),1)
		return (function()
			local _ = nil
			_ = G.call("技能效果_生命上限",count_119)
			_ = G.call("技能效果_攻击",count_119)
			return _
		end)()
	end)()
end
